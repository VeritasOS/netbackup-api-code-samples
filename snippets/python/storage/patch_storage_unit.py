...
def print_usage():
	print("Example:")
	print("python -W ignore patch_storage_unit.py -nbmaster <master_server> -username <username> -password <password> -payload <input JSON > -stu_name <storage unit name>[-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
reponse = storage.patch_storage_unit(jwt, base_url, payload, stu_name)
