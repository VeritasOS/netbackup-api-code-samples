...
def print_usage():
	print("Example:")
	print("python -W ignore get_all_replication_targets_on_diskvolume.py -nbmaster <master_server> -username <username> -password <password> -stsid <storage server id> -dvid <diskvolume id> [-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
response = storage.get_all_replication_targets_on_diskvolume(jwt, base_url, stsid, dvid)
