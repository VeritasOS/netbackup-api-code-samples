...
def print_usage():
	print("Example:")
	print("python -W ignore add_replication_target_on_diskvolume.py -nbmaster <master_server> -username <username> -password <password> -payload <input JSON > -stsid <storage server id> -dvid <diskvolume id> [-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
storage.add_replication_target_on_diskvolume(jwt, base_url, payload, stsid, dvid)
