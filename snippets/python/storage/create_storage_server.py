...
def print_usage():
	print("Example:")
	print("python -W ignore create_storage_server.py -nbmaster <master_server> -username <username> -password <password> -payload <input JSON > [-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
reponse = storage.create_storage_server(jwt, base_url, payload)
