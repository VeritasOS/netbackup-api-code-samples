...
def print_usage():
	print("Example:")
	print("python -W ignore delete_disk_pool.py -nbmaster <master_server> -username <username> -password <password> -dpid <disk pool id>[-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
storage.delete_disk_pools(jwt, base_url, dpid)