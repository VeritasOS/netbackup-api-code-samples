...
def print_usage():
	print("Example:")
	print("python -W ignore get_trusted_master_server_list.py -nbmaster <master_server> -username <username> -password <password> [-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
jobs = config.get_trusted_master_server_list(jwt, base_url)
