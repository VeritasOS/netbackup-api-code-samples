...
def print_usage():
	print("Example:")
	print("python -W ignore get_trusted_master_server_by_name.py -nbmaster <master_server> -username <username> -password <password> -trustedmasterservername <Trusted master Server Name> [-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
jobs = config.get_trusted_master_server_by_name(jwt, base_url, trustedmasterservername)
