...
def print_usage():
	print("Example:")
	print("python -W ignore delete_trust.py -nbmaster <master_server> -username <username> -password <password> -trustedmasterservername <Trusted Master Server Name>[-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
config.delete_trust(jwt, base_url, trustedmasterservername)