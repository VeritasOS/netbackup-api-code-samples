...
def print_usage():
	print("Example:")
	print("python -W ignore get_media_server.py -nbmaster <master_server> -username <username> -password <password> [-domainname <domain_name>] [-domaintype <domain_type>]\n\n\n")
...
jobs = config.get_media_servers(jwt, base_url)
