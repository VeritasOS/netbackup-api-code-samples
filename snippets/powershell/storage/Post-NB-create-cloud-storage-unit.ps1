...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for creating storage unit for cloud storage server.

.DESCRIPTION
This script will create storage unit for cloud storage server.

.EXAMPLE
./Post-NB-create-cloud-storage-unit.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret"
#>
