...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for fetching storage units.

.DESCRIPTION
This script will fetch storage units.

.EXAMPLE
./Get-NB-get-storage-unit.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret"
#>
