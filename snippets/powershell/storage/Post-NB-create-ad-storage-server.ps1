...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for creating Advanced disk storage server.

.DESCRIPTION
This script will create Advanced disk storage server.

.EXAMPLE
./Post-NB-create-ad-storage-server.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret"
#>
