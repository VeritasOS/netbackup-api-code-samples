...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for creating disk pool for cloud storage server.

.DESCRIPTION
This script will create disk pool for cloud storage server.

.EXAMPLE
./Post-NB-create-cloud-disk-pool.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret"
#>
...
$sts_uri = $basepath + "/storage/disk-pools"
