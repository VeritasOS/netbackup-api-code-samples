...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for updating msdp storage server.

.DESCRIPTION
This script will update msdp storage server.

.EXAMPLE
./Patch-NB-update-msdp-storage-server.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret" -stsid "storage server id"
#>
