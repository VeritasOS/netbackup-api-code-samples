...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for updating cloud storage server.

.DESCRIPTION
This script will update cloud storage server.

.EXAMPLE
./Patch-NB-update-cloud-storage-server.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret" -stsid "storage server id"
#>
