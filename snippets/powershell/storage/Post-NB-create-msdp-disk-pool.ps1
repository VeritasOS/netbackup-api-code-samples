...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for creating disk pool for msdp storage server.

.DESCRIPTION
This script will create disk pool for msdp storage server.

.EXAMPLE
./Post-NB-create-msdp-disk-pool.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret"
#>
