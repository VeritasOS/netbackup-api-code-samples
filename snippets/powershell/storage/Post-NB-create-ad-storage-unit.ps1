...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for creating storage unit for Advanced disk storage server.

.DESCRIPTION
This script will create storage unit for Advanced disk storage server.

.EXAMPLE
./Post-NB-create-ad-storage-unit.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret"
#>
