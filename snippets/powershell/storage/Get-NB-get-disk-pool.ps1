...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for fetching disk pools.

.DESCRIPTION
This script will fetch disk pools.

.EXAMPLE
./Get-NB-get-disk-pool.ps1 -nbmaster "nb-master.example.com" -username "administrator" -password "secret"
#>
