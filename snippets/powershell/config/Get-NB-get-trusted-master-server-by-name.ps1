...
.SYNOPSIS
This sample script demonstrates the use of NetBackup REST API for fetching scpecified trusted master server.

.DESCRIPTION
This script will fetch scpecified scpecified trusted master server.
